...
const firstDayOfWeek = getFirstDayOfWeek(year, month);
const selectedDayOfMonth = selectedDate && selectedDate.getFullYear() === year && selectedDate.getMonth() === month ? selectedDate.getDate() : null;
        ...
        <div id="calendar">
            ...
            <div className="days">
                ...
                {Array.from({ length: daysInMonth }, (_, index) => index + 1).map((day) => (
                    ...
                    <div key={day} className={`current-month-day ${selectedDayOfMonth === day ? "selected" : ""}`} onClick={() => handleDayClick(day)}>
                        {day}
                    </div>
                ))}
            ...
            <div className="buttons">
                <div className="cancel" onClick={CloseCalendar}>Cancel</div>
